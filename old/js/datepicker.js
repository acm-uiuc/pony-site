/*
        DatePicker v3.9 by frequency-decoder.com
...
function datePicker(options) {
        ...
        o.events = {
                ...
                onkeydown: function (e) {
                        ...
                        /*@cc_on
                        @if(@_win32)
                                if(new Date().getTime() - o.interval.getTime() < 60) return o.killEvent(e);
                                o.interval = new Date();
                        @end
                        @*/
        ...
        o.setDateFromInput = function() {
                ...
                if(!o.splitDate) {
                        ...
                        var tm = parseInt(mmN.tagName.toLowerCase() == "input" ? mmN.value || new Date().getMonth() + 1  : mmN.options[mmN.selectedIndex].value);
                        var td = parseInt(ddN.tagName.toLowerCase() == "input" ? ddN.value || new Date().getDate() : ddN.options[ddN.selectedIndex].value);
